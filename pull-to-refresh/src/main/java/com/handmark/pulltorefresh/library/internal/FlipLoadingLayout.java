...
//            mHeaderRefreshImage.setImageDrawable(getResources().getDrawable(R.drawable.default_ptr_rotate));
            mHeaderRefreshImage.setImageResource(R.drawable.progressbar);
            AnimationDrawable animationDrawable = (AnimationDrawable) mHeaderRefreshImage.getDrawable();
...
//            mHeaderRefreshImage.setAnimation(animation);
    ...
    protected int getDefaultDrawableResId() {
        return R.drawable.iconfont_downgrey;
    }
