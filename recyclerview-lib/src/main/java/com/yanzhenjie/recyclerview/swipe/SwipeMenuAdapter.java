...
import com.yanzhenjie.recyclerview.swipe.refresh.BaseRecyclerAdapter;
 ...
 */
public abstract class SwipeMenuAdapter<T, VH extends RecyclerView.ViewHolder> extends BaseRecyclerAdapter<T,VH> {
    protected SwipeMenuView swipeLeftMenuView, swipeRightMenuView;
    /**
     * Swipe menu creator。
     */
    ...
    public SwipeMenuAdapter(Context context, List<T> itemList) {
    ...
    public final VH onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (mSwipeMenuCreator != null) {
            ...
            if (leftMenuCount > 0) {
                swipeLeftMenuView = (SwipeMenuView) swipeMenuLayout.findViewById(R.id.swipe_left);
            ...
            if (rightMenuCount > 0) {
                swipeRightMenuView = (SwipeMenuView) swipeMenuLayout.findViewById(R.id.swipe_right);
        ...
        return onCompatCreateViewHolder(swipeLeftMenuView, swipeRightMenuView, contentView, viewType);
    }
     ...
     */
    public abstract VH onCompatCreateViewHolder(SwipeMenuView swipeLeftMenuView, SwipeMenuView swipeRightMenuView, View realContentView, int viewType);
     ...
     * @see #onCompatBindViewHolder(RecyclerView.ViewHolder, int, List)
     */
    private void onCompatBindViewHolder(VH holder, int position, List<Object> payloads){
