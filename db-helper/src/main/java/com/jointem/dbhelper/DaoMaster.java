...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(AreaCityDao.class);
        registerDaoClass(CategoriesDao.class);
        registerDaoClass(CityStationBeanDao.class);
        registerDaoClass(DownInfoDao.class);
        registerDaoClass(PressDao.class);
        registerDaoClass(SearchRecordDao.class);
        registerDaoClass(SiteDao.class);
        registerDaoClass(StationsHistoryDao.class);
