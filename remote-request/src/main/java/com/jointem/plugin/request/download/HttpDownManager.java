...
//                    }
    ...
    public void stopDown(DownLoadInfo info) {
        ...
        /*保存数据库信息和本地文件*/
//        DBRequestUtil.insertOrReplaceDownInfo(sContext, info.getDownInfo());//TODO 暂时注释
    }
...
//        DBRequestUtil.insertOrReplaceDownInfo(sContext, downLoadInfo.getDownInfo()); //TODO 暂时注释
    }
