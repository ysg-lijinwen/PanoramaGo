...
import com.quanjinggo.panoramago.util.DTListDialog
 ...
 */
class HomeFragment : MvpBaseFragment2<IViewHome, HomePresenter>(), IViewHome, IPanoPlayerListener, IPanoPlayerVideoPluginListener,
    ...
    internal val PanoPlayer_Template = "<DetuVr> " + "<settings init=\"pano1\" initmode=\"default\" enablevr=\"true\" title=\"\"/>" + "<scenes> " + "<scene name=\"pano1\" title=\"\" thumburl=\"\" >" + "<preview url=\"%s\" type=\"CUBESTRIP\" />" + "<image type = \"%s\" url =\"%s\" device = \"0\" />" + "<view fovmin='110' fovmax='170' gyroEnable=\"false\"/>" + "</scene>" + "</scenes>" + "</DetuVr>"
