package com.quanjinggo.base.view.swiplayoutview;
...
//            a.recycle();
//            ViewGroup decorContent = (ViewGroup) activity.getWindow().getDecorView().findViewById(Window.ID_ANDROID_CONTENT);
//            ViewGroup decorChild = (ViewGroup) decorContent.getChildAt(0);
//            decorChild.setBackgroundResource(background);
//
//            decorContent.removeView(decorChild);
//            addView(decorChild);
//            setContentView(decorChild);
//            decorContent.addView(this);
//        } else {
        mActivity = activity;
        TypedArray a = activity.getTheme().obtainStyledAttributes(new int[]{
                android.R.attr.windowBackground
