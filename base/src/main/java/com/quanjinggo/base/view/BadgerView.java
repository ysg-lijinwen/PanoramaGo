 ...
 * @author Jeff Gilfelt
 */
public class BadgerView extends AppCompatTextView {
     ...
     */
    public BadgerView(Context context, View target) {
     ...
     */
    public BadgerView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public BadgerView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public BadgerView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
