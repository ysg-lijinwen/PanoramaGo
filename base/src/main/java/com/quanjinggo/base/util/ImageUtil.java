package com.quanjinggo.base.util;
...
public class ImageUtil {
    ...
    //正在加载时的过渡图片，失败时展示此图片
    static {
        int defaultRectangleTransitImg = R.mipmap.ic_zsyx_loading;
        int defaultSquareTransitImg = R.mipmap.ic_zsyx_loading;
    ...
    public static void displayImage(Context context, String uri, ImageView imageView) {
        Glide.with(context)
                .load(uri)
                .placeholder(R.mipmap.ic_zsyx_loading)
                .error(R.mipmap.ic_zsyx_loading)
                .centerCrop()
                .crossFade()
                .into(imageView);
    }
...
//                });
    ...
    public static void saveImageToGallery(Context context, @NonNull Bitmap bmp) {
        ...
        String fileName = "zsyx" + System.currentTimeMillis() + ".jpg";
